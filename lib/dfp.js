  ...
  */
  return this.getCriteria(lineItem.customCriteriaKVPairs)
    .then(function(criteria) {
      ...
      delete lineItem.customCriteriaKVPairs;
      //console.log(JSON.stringify(lineItem.targeting.customTargeting.children));
      return lineItem;
    });
 ...
 *                             name passed in.
 */
Dfp.prototype.getAdvertiserByName = function(conditions) {
  var service = 'CompanyService';
  var method = 'getCompaniesByStatement';
  var q = `Where name = '${conditions.name}'`;
...
Dfp.prototype.replacePartnerName = function(_item) {
  ...
  return this.getAdvertiserByName(conditions)
...
Dfp.prototype.deleteAssociations = function(associations) {

  var service = 'LineItemCreativeAssociationService';
  var method = 'deleteLineItemCreativeAssociations';
